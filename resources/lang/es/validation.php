...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'sub_industry_id' => 'Sub-industria',
        'business_name' => 'Razón social',
        'trade_name' => 'Nombre de fantasía',
        'phone_number' => 'Teléfono',
        'mobile_number' => 'Celular',
        'business_code' => 'Código de comercio',
        'email' => 'Email',
        'street_name' => 'Calle',
        ...
        /*
        |--------------------------------------------------------------------------
        | Attribute customized for business owner
        |--------------------------------------------------------------------------
        |
        */
        'name_owner' => 'Nombre del títular',
        'last_name_owner' => 'Apellidos del títular',
        'cuil_owner' => 'Cuit del títular',
        'phone_number_owner' => 'Teléfono del títular',
        'mobile_number_owner' => 'Celular del títular',
        'email_owner' => 'Email del títular',
        'street_name_owner' => 'Calle del títular',
        'street_number_owner' => 'Número del títular',
        'location_owner' => 'Localidad del títular',
        'floor_owner' => 'Pisos del títular',
        'apartment_owner' => 'Departamento del títular',
        'postal_code_owner' => 'Código del títular',
        'city_owner' => 'Ciudad del títular',
        'requested_amount' => 'Importe a solicitar',
        'description' => 'descripciön'
    ],
